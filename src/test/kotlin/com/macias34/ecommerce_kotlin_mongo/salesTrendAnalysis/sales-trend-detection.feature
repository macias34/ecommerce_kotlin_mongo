Feature: Sales Trend Detection
  ...
  Scenario: Positive trend detection
  ...
  Scenario: Negative trend detection
  ...
  Scenario: Insignificant sales activity change is ignored
  ...
  Scenario: Sales activity change crossing the threshold is detected
    Given the system is configured with a detection threshold of 0.2
    And the product 'iPhone 16' has a base sales rate of 10 sales/hour
  ...
  Scenario: Repeated detection on a growing trend
    Given the product 'iPhone 16' has a base sales rate of 10 sales/hour
  ...
  Scenario: Detecting return to stability from a trending state
    Given the product 'iPhone 16' has a base sales rate of 10 sales/hour
    And the system's last known current sales rate for this product was 25 sales/hour
  ...
  Scenario: Detecting return to stability from an underperforming state
    Given the product 'iPhone 16' has a base sales rate of 20 sales/hour
  ...
  Scenario: First sale for a product with no previous sales history
  ...
  Scenario: Sales stop for a previously active product
    Given the product 'iPhone 16' has a base sales rate of 20 sales/hour
  ...
  Scenario: A dormant product remains dormant
    Given the product 'iPhone 16' has a base sales rate of 0 sales/hour
